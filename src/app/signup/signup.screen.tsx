...
export const SignupScreen: FC = () => {
    ...
    const {
        ...
        handleSubmit,
        errors,
        values: { password: passwordInputValue, username: usernameInputValue, company: companyInputValue,
            nit: nitInputValue, firstname: firstnameInputValue, lastname: lastnameInputValue },
    } = useFormik<{
        username: string
        password: string
        firstname: string
